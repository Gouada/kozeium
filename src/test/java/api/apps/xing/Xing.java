package api.apps.xing;

import api.android.Android;
import api.apps.interfaces.Application;

import static api.apps.xing.AppStaticData.APP_LAUNCHER_ACTIVITY_ID;
import static api.apps.xing.AppStaticData.APP_PACKAGE_ID;

public class Xing implements Application {
