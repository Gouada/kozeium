...
@CucumberOptions(plugin = { "pretty", "html:" + HTML_RESULT_FOLDER, "json:db_navogator_tripPlaner.json",
		"junit:db_navogator_tripPlaner.xml" }, features = DB_NAVIGATOR_FEATURES, glue = {
				DB_NAVIGATOR_TRIPPLANER_STEPS })
