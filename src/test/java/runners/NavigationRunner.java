...
import static core.constants.Steps.DB_NAVIGATOR_NAVIGATION_STEPS;
...
@CucumberOptions(plugin = { "pretty", "html:" + HTML_RESULT_FOLDER,
		"json:" + JSON_RESULT_FOLDER + "/db_navogator_navigation.json",
		"junit:" + XML_RESULT_FOLDER + "/db_navogator_navigation.xml" }, features = {
				DB_NAVIGATOR_FEATURES }, glue = { DB_NAVIGATOR_NAVIGATION_STEPS }, tags = { "@navigation" })
